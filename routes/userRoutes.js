...
router.get('/checkout/:requestId', authenticateToken, userController.checkout);
router.get("/requestedBooks", authenticateToken, userController.getRequestedBooks);
router.delete("/deleteBookIssueRequest/:bookId", authenticateToken, userController.deleteBookIssueRequest);
router.get("/viewIssuedBooks",authenticateToken, userController.viewIssuedBooks);
router.get("/returnBook",authenticateToken, userController.returnBook);
router.get("/fines",authenticateToken,userController.getFines);
router.get("/payFine/:requestId",authenticateToken,userController.payFine);
...
router.post('/pay', authenticateToken, (req, res) => {
    ...
    User.payFine(requestId,(err, result)=>{
        if(err){
